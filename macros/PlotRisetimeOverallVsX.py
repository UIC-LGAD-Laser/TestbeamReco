...
outdirTmp2 = myStyle.GetPlotsDir(outdirTmp1, "RisetimeOverall_vs_X_fits/")

#Get 3D histograms
channel_good_index = []
hname = "risetime_vs_xy"
...
print(th1_Xmin)
print(th1_Xmax)
list_risetime_vs_x = TH1F("risetime_vs_x","", th1_Nbins, th1_Xmin, th1_Xmax)
...
outputfile = TFile("%sPlotRisetimeOverallVsX.root"%(outdirTmp1),"RECREATE")
list_risetime_vs_x.Write()

outputfile.Close()

#Make final plots
plotfile = TFile("%sPlotRisetimeOverallVsX.root"%(outdirTmp1),"READ")
plotList_risetime_vs_x = plotfile.Get("risetime_vs_x")
...
canvas.SaveAs(outdir+"RisetimeOverall_vs_x_"+sensor+".gif")