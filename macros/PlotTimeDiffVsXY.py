...
parser.add_option('-z','--zmin', dest='zmin', default = 0.0, help="Set min TimeRes value in final plot")
...
all_histoInfos = [
    ...
    # HistoInfo("weighted2_timeDiff_tracker_vs_xy_noMetal", inputfile, "weighted2_timeDiff_tracker"),
]
