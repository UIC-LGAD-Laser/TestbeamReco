...
all_histoInfos = [
    HistoInfo("waveProf1nearStripX", inputfile, "Near strip", colors[0]),
    HistoInfo("waveProf1leftGapX", inputfile, "Left midgap", colors[1]),
    HistoInfo("waveProf1rightGapX", inputfile, "Right midgap", colors[2]),
...
all_histoInfos[0].th1.SetMinimum(-100)
...
canvas.SaveAs(outdir+"Waveforms.png")
