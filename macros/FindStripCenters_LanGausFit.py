...
for channel in range(nStrips):
    ...
    for i in range(1, list_amplitude_vs_x[channel].GetXaxis().GetNbins()):
        #print ("Bin " + str(i))
        # print(list_amplitude_vs_x[channel].GetXaxis().GetBinCenter(i))
        ##For Debugging
        #if not (i==46 and j==5):
        #    continue
...
for i in range(nStrips):
    list_amplitude_vs_x[i].Draw("hist same")
    #list_of_fit_functions[i].Draw("same")

# for i in range(3):
#     print("\n")
#     print("Content for channel = ",i)
#     for j in range(list_amplitude_vs_x[i].GetXaxis().GetNbins()):
#         print(list_amplitude_vs_x[i].GetBinContent(j))
print("\n")
...
print("Bins: ",list_amplitude_vs_x[0].FindBin(0.25),list_amplitude_vs_x[1].FindBin(0.25),list_amplitude_vs_x[1].FindBin(-0.25),list_amplitude_vs_x[2].FindBin(-0.25))
...
first_good_channel = 3 - nStrips
string_for_geo = "std::vector<double> stripCenterXPosition = {"
for channel in range(4):
    if ((first_good_channel <= channel) and (channel < 3)):
